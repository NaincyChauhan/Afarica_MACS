...
$(function() {
    ...
    $('#addeventbannerForm').validate({
        ...
        submitHandler: function(f) {
            var btn = $('#addeventbannerBTN'),
                form = $('#addeventbannerForm');
...
function updateValidation() {
    $('#updateeventbannerForm').validate({
        rules: {
            title: "required",
        },
        messages: {
        ...
        submitHandler: function(form) {
            var btn = $('#updateeventbannerBTN'),
                form = $('#updateeventbannerForm');
            btn.attr('disabled', true);
            btn.html('Saving <i class="mdi mdi-cloud-circle"></i>');
            $.ajax({
                type: "POST",
...
function loadAjaxTable() {
    $.ajax({
        type: "GET",
        url: "ajax/load-eventbanner-table",
        data: {},
        success: function(data) {
