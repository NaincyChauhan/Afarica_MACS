...
@section('js')
    ...
    <script src="{{ asset('app-assets/masterX/js/listing-enquiry.js') }}"></script>
@endsection
@section('content')
                    ...
                    <table id="shivadatatable" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$message->name}} </td>
                                <td><a target="_blank" href="{{route('listing-detail',['slug'=>$message->listing->slug])}}">{{$message->listing->title}}</a> </td>
                                <td>{{$message->email}} </td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">                                        
                                        <a class="btn btn-danger btn-sm btn-icon-text"
                                            ...
                                            href="{{ route('listingenquiry.destroy', $message->id) }}">
                                            Delete
