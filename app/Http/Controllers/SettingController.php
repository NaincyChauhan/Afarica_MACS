...
class SettingController extends Controller
{
    ...
    public function settingUpdate(Request $request)
    {
        ...
        if($request->hasFIle('logo'))
        {
            ...
            $file_name = (string) Str::of(config('app.name'))->slug('_').'_logo.'. $file->getClientOriginalExtension();
        ...
        $setting->it_consultancy_money = $request->it_consultancy_money;
        $setting->health_consultancy_money = $request->health_consultancy_money;
        $setting->save();
